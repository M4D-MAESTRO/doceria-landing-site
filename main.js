...
const routes = [
    ...
    {
        path: 'home',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_home_home_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/home/home.module */ 1572)).then(m => m.HomePageModule),
    },
];
...
let AppComponent = class AppComponent {
    constructor(loaderService, dialogService, preferencesService, themeService, primeConfig, translateService) {
        ...
        if (theme === 'dark') {
            ...
            this.isDarkTheme = false;
            this.themeService.switchTheme('saga-blue-p');
        }
    }
    ngOnInit() {
...
const MODE = 'DEV';
const SYSTEM_NICKNAME = 'home.title-welcome';
const SYSTEM_NAME = 'Luís Henrique de Castro Corrêa';
const SYSTEM_VERSION = '0.0.1';
const SYSTEM_LOGO = 'assets/imgs/logos/logo-small-no-bg.png';
const SYSTEM_INFO = {
    MODE,
    SYSTEM_NICKNAME,
    SYSTEM_NAME,
